...
armature.animation_data.action = bpy.data.actions.get("Drink")
...
scene.render.filepath = r"C:\Users\skynamecat\Documents\ChatGPT\skynamecat.github.io\tmp\fbx-convert\drink-preview.png"
