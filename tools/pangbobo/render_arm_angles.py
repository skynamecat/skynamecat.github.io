...
for bone_name, turns in (
    ("RightShoulder", (((0, 1, 0), 18),)),
    ("RightArm", (((0, 1, 0), 52),)),
    ("RightForeArm", (((0, 1, 0), 40),)),
):
    bone = armature.pose.bones[bone_name]
    bone.rotation_mode = "QUATERNION"
    rotation = Quaternion()
    for world_axis, angle in turns:
        axis = (bone.bone.matrix_local.to_3x3().inverted() @ Vector(world_axis)).normalized()
        rotation = rotation @ Quaternion(axis, radians(angle))
    bone.rotation_quaternion = rotation
bpy.context.view_layer.update()
scene.render.filepath = r"C:\Users\skynamecat\Documents\ChatGPT\skynamecat.github.io\tmp\fbx-convert\wave-shoulder-preview.png"
